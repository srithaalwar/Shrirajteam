...
// below code is updated code dated - 28/02/2026
// below is the without mobile view adjusted 
...
const FilterSidebar = ({ 
  ...
  const [activeFilters, setActiveFilters] = useState({
      transaction: false,   // Now closed by default
      role: false,          // Now closed by default
      categories: false,    // Now closed by default
      price: false,         // Now closed by default
      type: false,          // Now closed by default
      location: false       // Now closed by default
  });
