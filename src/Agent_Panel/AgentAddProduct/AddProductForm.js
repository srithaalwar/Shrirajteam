...
//     return_days: 7,
//     product_commission: '',
//     offer_id: '', // Changed from 'offer' to 'offer_id' to match Django's expectation
//     media: [{ media_type: 'image', sort_order: 0, is_primary: true }]
//   }]);
...
//     if (!userId) {
//       console.error('Cannot fetch offers: User ID is not available');
//       return;
//     }
...
//       return_days: 7,
//       product_commission: '',
//       offer_id: '', // Changed from 'offer' to 'offer_id'
//       media: [{ media_type: 'image', sort_order: 0, is_primary: true }]
//     }]);
//     setVariantMediaFiles(prev => [...prev, []]);
//     setVariantAttributes(prev => [...prev, [{ key: '', value: '' }]]);
...
//         // Create variant object with offer_id instead of offer
//         const variantObj = {
//           sku: variant.sku || '',
//           mrp: variant.mrp === '' ? 0 : parseFloat(variant.mrp) || 0,
//           selling_price: variant.selling_price === '' || variant.selling_price === null ? null : parseFloat(variant.selling_price),
...
//         // Add offer_id only if it has a value (not empty string)
//         if (variant.offer_id && variant.offer_id !== '') {
//           variantObj.offer_id = parseInt(variant.offer_id); // Use offer_id instead of offer
//         }
...
//                         name="offer_id" // Changed from 'offer' to 'offer_id'
...
//                       </select>
//                       <div className="form-text">
//                         Select an offer to apply to this variant. Leave empty for no offer.
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//     cgst_percent: 0,
//     sgst_percent: 0,
//     tax_percent: 0, // Added tax_percent field
//     hsn_code: '',
//     weight_kg: '',
//     length_cm: '',
//     width_cm: '',
...
//         // Create variant object with offer_id instead of offer and added tax_percent
//         const variantObj = {
//           sku: variant.sku || '',
//           mrp: variant.mrp === '' ? 0 : parseFloat(variant.mrp) || 0,
//           selling_price: variant.selling_price === '' || variant.selling_price === null ? null : parseFloat(variant.selling_price),
...
//           cgst_percent: variant.cgst_percent === '' ? 0 : parseFloat(variant.cgst_percent) || 0,
//           sgst_percent: variant.sgst_percent === '' ? 0 : parseFloat(variant.sgst_percent) || 0,
//           tax_percent: variant.tax_percent === '' ? 0 : parseFloat(variant.tax_percent) || 0, // Added tax_percent field
//           hsn_code: variant.hsn_code || '',
//           weight_kg: variant.weight_kg === '' ? null : (parseFloat(variant.weight_kg) || null),
//           length_cm: variant.length_cm === '' ? null : (parseFloat(variant.length_cm) || null),
//           width_cm: variant.width_cm === '' ? null : (parseFloat(variant.width_cm) || null),
...
//       // Navigate to /agent-busineess-category after success
...
//       // Reset form (optional - you can keep or remove this)
//       setProductData({
//         business: '',
//         product_name: '',
//         description: '',
...
//                 {/* New Row: Tax Percent and Offer Selection */}
//                 <div className="row">
//                   <div className="col-md-6">
//                     <div className="mb-3">
