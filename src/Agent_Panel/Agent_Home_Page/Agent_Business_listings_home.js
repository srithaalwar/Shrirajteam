...
//       // Filter businesses that have banners only
//       const businessesWithBanners = businessesData.filter(business => 
//         business.banner && 
//         business.banner.trim() !== ""
//       );
...
//       console.log("Businesses with banners:", businessesWithBanners.length);
//       console.log("Businesses details:", businessesWithBanners.map(b => ({ 
//         id: b.business_id, 
...
//       // FIXED: Group businesses by ALL their categories (not just the first one)
//       const grouped = {};
//       businessesWithBanners.forEach(business => {
//         // Check if business has categories
//         if (business.categories && business.categories.length > 0) {
//           // Iterate through ALL categories the business belongs to
//           business.categories.forEach(categoryId => {
//             if (!grouped[categoryId]) {
//               grouped[categoryId] = [];
//             }
//             // Add business to this category group (avoid duplicates)
//             const existingBusiness = grouped[categoryId].find(
...
//           });
//         } else {
//           // If no categories, put in "uncategorized" group
//           const uncategorizedId = "uncategorized";
//           if (!grouped[uncategorizedId]) {
...
//       console.log("Grouped businesses by categories:", Object.keys(grouped).length, "categories");
//       console.log("Category groups:", Object.keys(grouped).map(key => ({
//         categoryId: key,
//         businessCount: grouped[key].length
//       })));
...
// const handleViewAll = (categoryId) => {
//   const categoryInfo = categoriesMap[categoryId];
//   console.log("View All clicked for category:", categoryId, categoryInfo);
//   navigate(`/agent-home-subcategory/${categoryId}`, { 
//     state: { 
...
//                             }}
//                           >
//                             {/* Business Info Overlay - commented out */}
//                           </div>
//                         </div>
//                       );
//                     })}
...
const AgentHome = () => {
  ...
  const fetchAllCategories = async () => {
    ...
    try {
      ...
      setCategoriesMap(map);
      console.log("Loaded business categories:", Object.keys(map).length);
              ...
              return (
                <div key={categoryId} className="mani-as-offer-wrapper">
                  <div className="mani-as-offer-header">
                    ...
                    {categoryId !== "uncategorized" && categoryInfo && (
                      <div className="mani-as-offer-viewall-wrap">
                        <button
                          onClick={() => handleViewAll(categoryId)}
                          className="mani-as-offer-viewall-btn"
