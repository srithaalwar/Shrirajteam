...
function AgentMyOrders() {
  ...
  const calculateOrderTaxes = (order) => {
    ...
    return {
      ...
      subtotal: subtotal - (totalCgst + totalSgst) // Subtotal without tax
    };
  };
  ...
  const handleDownloadInvoice = async (order) => {
    ...
    try {
      ...
      // Create detailed invoice content with tax breakdown
      let invoiceContent = `
=========================================
                INVOICE
=========================================
...
TAX SUMMARY:
-----------------------------------------
Subtotal (without tax): ₹${taxes.subtotal.toFixed(2)}
