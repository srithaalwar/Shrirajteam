...
//     { path: "/a-service-providers", name: "My Services", icon: <FaUserTie /> },
...
const AgentNavbar = () => {
  ...
  // Service Bookings submenu items
  const serviceBookingsItems = [
    { path: "/agent-service-bookings", name: "Bookings", icon: <FaBookmark /> },
    { path: "/agent-my-service-bookings", name: "My Service Bookings", icon: <FaCalendarCheck /> }
  ];
  ...
  const menuItems = [
    ...
    // NEW: Service Bookings Main Category
    {
      name: "Service Bookings",
      icon: <FaCalendarCheck />,
      subMenu: serviceBookingsItems,
    },
