...
//           <small className="text-muted">Distribution Commission: ₹{parseFloat(distributionCommission || 0).toLocaleString()}</small>
//         </div> */}
...
//        // Inside the ListPropertyItem component in PropertyGrid
// const ListPropertyItem = ({ property, commissionData }) => {
//   const [showCommissionTooltip, setShowCommissionTooltip] = useState(false);
...
//           return <ListPropertyItem key={property.property_id} property={property} commissionData={commissionData} />;
//         })}
//       </div>
//     );
//   }
...
//==============================================================
//===============================================================================
// Added view details button disabled if the user does not have subscription plan
...
//==============================================================
// adjusted in Mobile view filter option 
...
//           </button>
//         </div>
//         <p className="mb-0 text-muted d-md-none mt-2">
//           Showing <span className="fw-semibold text-dark">{showingProducts}</span> of{" "}
//           <span className="fw-semibold text-primary">{totalProducts}</span>{" "}
//           properties
//         </p>
...
//           <div className="btn-group d-none d-md-flex" role="group" aria-label="View mode">
//             {viewButtons.map(({ mode, icon: Icon, label }) => (
//               <button
//                 key={mode}
//                 onClick={() => onViewModeChange(mode)}
