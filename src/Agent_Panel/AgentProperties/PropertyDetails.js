...
const AgentPropertyDetails = () => {
  ...
  const getMediaTypeIcon = (type) => {
    return type === "video" ? <Video size={14} /> : <Image size={14} />;
  };
  ...
  return (
    <>
      ...
      <div className="product-wrapper">
        ...
        <div className="product-layout">
          ...
          <div className="buy-box">
            ...
            {/* Media Stats */}
            <div className="media-stats" style={{ marginBottom: '15px', fontSize: '12px', color: '#666' }}>
              <span>📷 {property.images?.length || 0} Images</span>
              <span style={{ marginLeft: '10px' }}>🎥 {property.videos?.length || 0} Videos</span>
            </div>
      ...
      {/* Add custom CSS for video thumbnails and container */}
      <style jsx>{`
        .video-container {
          width: 100%;
          height: 100%;
