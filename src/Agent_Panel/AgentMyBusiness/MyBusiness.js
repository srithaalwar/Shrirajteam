...
//     const handleViewProducts = (businessId) => {
//     navigate(`/agent-my-products/?business=${businessId}`);
//   };
...
//                     {/* Card Footer - Updated for better responsiveness */}
//                     <div className="business-card-footer">
//                       {/* View Products Button - Full width on all devices */}
//                       <button 
//                         className="btn btn-primary btn-sm w-100 view-products-btn mb-2"
//                         onClick={() => handleViewProducts(business.business_id)}
//                         style={{
//                           backgroundColor: '#273c75',
//                           borderColor: '#273c75',
...
//     const response = await axios.get(
//       `${baseurl}/business/?user_id=${userId}`,  // Pass user_id as query parameter
//       {
//         headers: {
//           'Content-Type': 'application/json'
...
//     // If the response is an array, use it directly; if it's an object with results, use that
...
//       headers: {
//         'Content-Type': 'application/json'
//         // Remove Authorization header if categories don't require authentication
//       }
//     });
//     const businessCategories = Array.isArray(response.data)
//       ? response.data.filter(cat => cat.level === 'business')
...
//   if (result.isConfirmed) {
//     try {
//       await axios.delete(`${baseurl}/business/${businessId}/?user_id=${userId}`, {
//         headers: {
//           'Content-Type': 'application/json'
...
//   const handleView = (businessId) => {
//   navigate(`/view-business/${businessId}`);  // This will now use the new ViewBusiness component
// };
      ...
      <div className="container-fluid business-list-container">
        ...
        {/* {getActiveBadge(business.is_active)} */}
                    ...
                    <div className="business-card-footer">
                      ...
                      <div className="view-enquiries-section mb-3">
                        <button
                          className="btn btn-info btn-sm w-100 d-flex align-items-center justify-content-center"
                          onClick={() => handleViewEnquiries(business.business_id)}
                          style={{
