...
// // ============= Category Sidebar Component with Checkboxes =============
...
//     return filterCategoryTree([...categories], categorySearch);
...
//       {selectedCategories.length > 0 && (
//         <div className="mt-4">
//           <h6 className="fw-semibold mb-2 small">Selected Categories:</h6>
...
//       setProductsLoading(false);
//     }
//   }, [productsSearch, selectedPriceRanges, selectedDiscountRanges, selectedCategories, currentUserId]);
...
//         <div className="row">
//           {/* Left Sidebar - Categories with Checkboxes */}
...
// below code without the filters button in mobile view 
...
//  below code with the filters button modelpopup in the Mobile view 
      ...
      >
        {hasChildren && (
          <button
            onClick={handleExpandToggle}
            className="btn btn-link p-0 me-1 text-muted"
            style={{ minWidth: '10px', textDecoration: 'none' }}
            aria-label={isExpanded ? "Collapse category" : "Expand category"}
          >
            {isExpanded ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
          </button>
...
const ProductHeader = ({ 
  ...
  return (
    <div className="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
      ...
      {/* Right side - Search, Filter button (mobile), and View modes */}
      <div className="d-flex align-items-center gap-2 flex-nowrap">
        <div className="input-group" style={{ width: '250px' }}>
          <span className="input-group-text bg-transparent border-end-0">
            <Search size={16} className="text-muted" />
        ...
        <div className="btn-group d-none d-md-inline-flex" role="group" aria-label="View mode">
          {views.map(({ mode, icon: Icon, label }) => (
            <button
              key={mode}
              onClick={() => onViewModeChange(mode)}
    ...
    <>
      ...
      <div className="container py-4">
        ...
        <div className="row">
          ...
          {/* Filter Sidebar - Left Column (Hidden on mobile) */}
