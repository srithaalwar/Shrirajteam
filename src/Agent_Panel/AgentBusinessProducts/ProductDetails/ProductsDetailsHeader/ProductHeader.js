...
// Import default business logo - adjust the path according to your project structure
import defaultBusinessLogo from "../../../../Logos/download-123.png"; // Update this path
...
const ShopHeader = ({ businessId }) => {
  ...
  // Function to get logo URL with fallback
  const getLogoUrl = () => {
    if (!business?.logo || logoError) {
