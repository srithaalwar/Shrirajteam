...
//     try {
//       // Handle DD-MM-YYYY format (common in Indian systems)
...
//       // Format the date of birth to YYYY-MM-DD for the date input field
//       const formattedDateOfBirth = formatDateForInput(user.date_of_birth);
...
//         // Send date in YYYY-MM-DD format (already in correct format from input)
//         if (value && value.trim() !== "") {
//           form.append(key, value);
//         }
//       } else {
...
const TeamEditProfile = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      // Check if user has first_name/last_name
      const hasFL = (user.first_name && user.first_name.trim() !== "") || 
                    (user.last_name && user.last_name.trim() !== "");
      setHasFirstLastName(hasFL);
        ...
        <div className="card p-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <h5 className="mb-3" style={{color: "rgb(30, 10, 80)"}}>Basic Information</h5>
              <div className="row">
                {/* Show Full Name field for users who registered with full_name */}
                {!hasFirstLastName && (
                ...
                {/* Show First Name & Last Name fields for users who registered with first_name/last_name */}
                {hasFirstLastName && (
                  <>
                    <div className="col-md-6 mb-3">
                      <label className="form-label">First Name</label>
            ...
            {/* Banking Details - Same as before */}
            <div className="mb-4">
              <h5 className="mb-3" style={{color: "rgb(30, 10, 80)"}}>Banking Details</h5>
              <div className="row">
                {[
            ...
            {/* KYC Verification - Same as before */}
            <div className="mb-4">
              <h5 className="mb-3" style={{color: "rgb(30, 10, 80)"}}>KYC Verification</h5>
              <div className="row">
                <div className="col-md-6 mb-3">
            ...
            {/* Nominee Details - Same as before */}
            <div className="mb-4">
              <h5 className="mb-3" style={{color: "rgb(30, 10, 80)"}}>Nominee Details</h5>
              <div className="row">
                <div className="col-md-6 mb-3">
            ...
            {/* Nominee Uploads - Same as before */}
            <div className="mb-4">
              <h5 className="mb-3" style={{color: "rgb(30, 10, 80)"}}>Nominee Uploads</h5>
              <div className="row">
                {[
