...
//   // State to track which phone numbers are visible
...
//   // Function to handle phone icon click - opens dialer pad with the phone number
//   const handlePhoneIconClick = (providerId, phoneNumber) => {
//     if (phoneNumber) {
...
//   const togglePhoneNumber = (providerId) => {
...
//                     {/* Phone - Hidden with clickable icon that opens dialer */}
//                     <div className="mb-2 d-flex align-items-start gap-2">
//                       <i 
//                         className="bi bi-telephone-fill text-success fs-6 mt-1 flex-shrink-0"
//                         style={{ cursor: 'pointer' }}
//                         onClick={() => handlePhoneIconClick(provider.provider_id, provider.mobile_number)}
//                         title="Click to call"
//                       ></i>
//                       <div className="small">
//                         <strong>Phone:</strong>{' '}
//                         <span 
//                           onClick={() => togglePhoneNumber(provider.provider_id)}
//                           style={{ cursor: 'pointer', textDecoration: 'underline', textDecorationStyle: 'dotted' }}
//                           title="Click to show/hide number"
//                         >
//                           {visiblePhoneNumbers[provider.provider_id] 
//                             ? provider.mobile_number 
//                             : maskPhoneNumber(provider.mobile_number)}
//                         </span>
//                         <i 
//                           className="bi bi-eye ms-2" 
//                           style={{ fontSize: '12px', cursor: 'pointer', opacity: 0.7 }}
//                           onClick={() => togglePhoneNumber(provider.provider_id)}
//                           title={visiblePhoneNumbers[provider.provider_id] ? "Hide number" : "Show number"}
//                         ></i>
//                       </div>
//                     </div>
