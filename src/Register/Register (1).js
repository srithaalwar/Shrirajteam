...
//     const redirectUrl = sessionStorage.getItem('redirect_after_register');
//     const checkoutCart = sessionStorage.getItem('checkout_cart');
    
//     if (redirectUrl) {
//       sessionStorage.removeItem('redirect_after_register');
//       navigate(redirectUrl);
//     } else if (checkoutCart) {
//       // If there's a checkout cart, redirect based on role
//       const selectedRole = roles.find(r => r.role_id === formData.role_ids[0]);
//       if (selectedRole?.role_name === "Agent") {
//         navigate('/agent-add-to-cart');
//       } else if (selectedRole?.role_name === "Client") {
//         navigate('/client-add-to-cart');
//       } else {
//         navigate('/login');
//       }
