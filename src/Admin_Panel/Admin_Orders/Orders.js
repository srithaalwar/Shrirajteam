...
function Orders() {
  ...
  const [usersCache, setUsersCache] = useState({}); // Cache for user details
  ...
  // Toggle order details and fetch user data when expanded
  ...
  // Get user display name (prioritize full_name, then first_name + last_name)
