...
//       // Filter to only show property and product variant notifications
//       const filteredNotifications = allNotifications.filter(notification => 
//         (notification.property && notification.property.id) || 
//         (notification.product_variant && notification.product_variant.id)
//       );
      
//       // Update unread count from API response or calculate locally
//       const apiUnreadCount = response.data.unread_count;
//       if (apiUnreadCount !== undefined) {
//         // Filter to count only property and product variant notifications
//         const filteredUnreadCount = allNotifications.filter(n => 
//           !n.is_read && 
//           ((n.property && n.property.id) || (n.product_variant && n.product_variant.id))
//         ).length;
//         setUnreadCount(filteredUnreadCount);
//       } else {
//         // Fallback: Calculate unread count locally for filtered notifications
//         const localUnreadCount = filteredNotifications.filter(n => !n.is_read).length;
//         setUnreadCount(localUnreadCount);
//       }
...
//         product_variant: notification.product_variant,
...
//         console.log("Navigating to admin property:", notification.property.id);
//         navigate(`/admin-properties-details/${notification.property.id}`);
//       } else if (notification.product_variant && notification.product_variant.id) {
//         // Navigate to admin product details with product_id and variant_id
//         console.log("Product Variant Notification Details:", {
//           product_variant_id: notification.product_variant.id,
//           product_id: notification.product_variant.product,
//           product: notification.product
//         });
        
//         // Try to get product_id from different possible locations
//         let productId = null;
//         let variantId = notification.product_variant.id;
        
//         // Option 1: Check if product_variant has product field (could be ID or object)
//         if (notification.product_variant.product) {
//           if (typeof notification.product_variant.product === 'object') {
//             productId = notification.product_variant.product.id;
//           } else {
//             productId = notification.product_variant.product; // Assuming it's the ID
//           }
//         }
//         // Option 2: Check if there's a separate product object
//         else if (notification.product && notification.product.id) {
//           productId = notification.product.id;
//         }
//         // Option 3: Check if product field exists in notification
//         else if (notification.product && typeof notification.product === 'number') {
//           productId = notification.product;
//         }
        
//         // If we have both productId and variantId, navigate to the correct URL
//         if (productId && variantId) {
//           console.log(`Navigating to admin product: product_id=${productId}, variant_id=${variantId}`);
//           navigate(`/admin-business-product-details/${productId}/?variant=${variantId}`);
//         } else if (productId) {
//           // Fallback: If we only have productId
//           console.log(`Navigating to admin product with only product_id: ${productId}`);
//           navigate(`/admin-business-product-details/${productId}/`);
//         } else if (variantId) {
//           // Fallback: If we only have variantId
//           console.log(`Navigating to admin product with only variant_id: ${variantId}`);
//           navigate(`/admin-product-details/${variantId}`);
//         } else {
//           console.log("No product or variant ID found in notification");
//           // Refresh notifications as fallback
//           fetchNotifications();
//         }
//       }
...
//         navigate(`/admin-property-details/${notification.property.id}`);
//       } else if (notification.product_variant && notification.product_variant.id) {
//         // Try to extract product_id and variant_id for navigation
//         let productId = null;
//         let variantId = notification.product_variant.id;
...
//             productId = notification.product_variant.product.id;
//           } else {
//             productId = notification.product_variant.product;
//           }
//         } else if (notification.product && notification.product.id) {
//           productId = notification.product.id;
//         } else if (notification.product && typeof notification.product === 'number') {
...
//   // Format notification message for property and product variant only
//   const formatNotificationMessage = (notification) => {
//     if (notification.property) {
//       return (
//         <div className="wn-notification-message-content">
...
//             <div className="wn-notification-detail">
//               Property: {notification.property.property_title}
//             </div>
//           )}
//         </div>
//       );
//     } else if (notification.product_variant) {
//       return (
//         <div className="wn-notification-message-content">
//           <strong className="wn-notification-title">{notification.message}</strong>
//           <div className="wn-notification-subtitle">Product Variant Update</div>
//           {notification.product_variant.variant_name && (
//             <div className="wn-notification-detail">
//               Variant: {notification.product_variant.variant_name}
//             </div>
//           )}
//         </div>
//       );
...
//                   ) : (
//                     <div className="wn-no-notifications">
//                       No property or product notifications yet
//                     </div>
//                   )}
//                 </div>
...
//=================================================
// Below code without Grouping of sidebar icons 
...
//         const filteredUnreadCount = allNotifications.filter(n => 
//           !n.is_read && 
//           (n.property !== null || n.product !== null)
//         ).length;
//         setUnreadCount(filteredUnreadCount);
//       } else {
//         // Fallback: Calculate unread count locally for filtered notifications
...
//============================================================
// below code is the fixed grouping of the sidebar icons 
...
const AdminNavbar = () => {
  ...
  const menuItems = [
    ...
    { path: "/a-leads", name: "Leads", icon: <FaChartLine /> },
    { path: "/admin-reports", name: "Reports", icon: <FaFileAlt /> },
    { path: "/a-settings", name: "Prefix Settings", icon: <FaTag /> },
    { path: "/admin-profile", name: "Profile", icon: <FaUserCircle /> },
  ];
