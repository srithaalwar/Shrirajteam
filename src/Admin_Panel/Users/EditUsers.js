...
const EditUser = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    account_type: "",
    ifsc_code: "",
    upi_id: "", // UPI ID in banking section
    nominee_reference_to: "",
    nominee_relationship: "",
    kyc_status: "pending",
  });
  ...
  const fetchUserData = async () => {
    try {
      ...
      setFormData({
        ...
        account_type: userData.account_type || "",
        ifsc_code: userData.ifsc_code || "",
        upi_id: userData.upi_id || "", // UPI ID from banking section
        nominee_reference_to: userData.nominee_reference_to || "",
        nominee_relationship: userData.nominee_relationship || "",
        kyc_status: userData.kyc_status || "pending",
      });
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.upi_id && !formData.upi_id.includes("@")) {
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "Please enter a valid UPI ID (should contain @ symbol)",
        confirmButtonColor: "#6C63FF",
      });
      return;
    }
    ...
    try {
      ...
      const updateData = {
        ...
        account_type: formData.account_type || null,
        ifsc_code: formData.ifsc_code || null,
        upi_id: formData.upi_id || null, // UPI ID in banking section
        nominee_reference_to: formData.nominee_reference_to || null,
        nominee_relationship: formData.nominee_relationship || null,
        kyc_status: formData.kyc_status,
      };
            ...
            <div className="row mb-4">
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  disabled={loading}
                />
                <small className="text-muted">Format: phonenumber@bankname (e.g., 9876543210@ybl)</small>
              </div>
            </div>
