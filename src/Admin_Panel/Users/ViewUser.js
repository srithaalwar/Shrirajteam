        ...
        <div className="card p-4">
          ...
          <div className="row mt-2">
            <div className="col-12 mb-4">
              <div className="card">
                <div className="card-header" style={{ backgroundColor: '#273c75', color: 'white' }}>
                  <h6 className="mb-0">Banking Information</h6>
                </div>
                <div className="card-body">
                  <div className="row">
          ...
          <div className="row">
            <div className="col-12 mb-4">
              <div className="card">
                <div className="card-header" style={{ backgroundColor: '#273c75', color: 'white' }}>
                  <h6 className="mb-0">Nominee Information</h6>
                </div>
                <div className="card-body">
                  <div className="row">
                    <div className="col-md-6 mb-2">
                      <div className="row">
                        <div className="col-6">
                          <strong>Nominee Reference To:</strong>
                        </div>
                        <div className="col-6">
                          {user.nominee_reference_to || "N/A"}
                        </div>
                      </div>
                    </div>
