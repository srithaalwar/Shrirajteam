...
//========================================================================
// Updated code Dated on 07/03/2026
...
//                         {/* <tr><th>Owner Email</th><td>{property.owner_email}</td> */}
...
const AdminPropertyDetails = () => {
  ...
  // Render text with read more/less functionality
  const renderExpandableText = (text, sectionName, placeholder = "No information available.") => {
    if (!text || text.trim() === "") {
      return <p className="desc text-muted">{placeholder}</p>;
    }

    const isExpanded = expandedSections[sectionName];
    const shouldTruncate = text.length > CHAR_LIMIT;
    const displayText = (!shouldTruncate || isExpanded) ? text : truncateText(text, CHAR_LIMIT);
  ...
  return (
    <>
          ...
          <div className="info-accordion">
            ...
            {openAbout && (
              <div className="info-body">
                ...
                <div className="property-description-section">
                  <h4>Description</h4>
                  {renderExpandableText(property.description, "description", "No description available.")}
                </div>
                ...
                <div className="property-specifications-section">
                  ...
                  <div className="property-details-grid">
                    ...
                    <div className="detail-column">
                      {/* Location Advantages with Read More/Read Less */}
                      <h4>Location Advantages</h4>
                      {renderExpandableText(property.location_advantages, "locationAdvantages", "Prime location with excellent connectivity.")}
                      
                      {/* Property Uniqueness with Read More/Read Less */}
                      <h4>Property Uniqueness</h4>
                      {renderExpandableText(property.property_uniqueness, "propertyUniqueness", "Well-maintained property with modern amenities.")}
                      
                      {/* Other Features with Read More/Read Less */}
                      <h4>Other Features</h4>
                      {renderExpandableText(property.other_features, "otherFeatures", "Spacious and well-ventilated.")}
                    </div>
                  </div>
      ...
      {/* Styles for video thumbnails and read more */}
      <style jsx>{`
        .video-thumbnail {
          position: relative;
          width: 100%;
