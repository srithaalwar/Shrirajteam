...
//     const apiEndpoint = `${baseurl}/summary/`; // Changed from /admin-summary/
...
//       subscription_summary, 
//       user_summary,
//       order_summary // Added order_summary from your API
//     } = summary;
...
//     // Get active/inactive counts for roles
//     const getRoleActiveCount = (roleName) => {
//       if (!user_summary.role_wise) return 0;
//       const roleData = user_summary.role_wise.find(r => r.role === roleName);
//       return roleData ? (roleData.active || 0) : 0;
//     };

//     const getRoleInactiveCount = (roleName) => {
//       if (!user_summary.role_wise) return 0;
//       const roleData = user_summary.role_wise.find(r => r.role === roleName);
//       return roleData ? (roleData.inactive || 0) : 0;
//     };
...
// Card background colors - more professional
const cardColors = [
  "linear-gradient(135deg, #1833b0 0%, #764ba2 100%)",
  "linear-gradient(135deg, #c41ed7 0%, #f5576c 100%)",
  "linear-gradient(135deg, #1d70b9 0%, #09e9f5 100%)",
  "linear-gradient(135deg, #0eba47 0%, #0ef2c8 100%)",
  "linear-gradient(135deg, #cb0d46 0%, #e5c50e 100%)",
  "linear-gradient(135deg, #0ad3c9 0%, #b10a3f 100%)",
  "linear-gradient(135deg, #08877e 0%, #8b1bd0 100%)",
  "linear-gradient(135deg, #ca1396 0%, #c2ab15 100%)",
  "linear-gradient(135deg, #0c9da8 0%, #66a6ff 100%)",
  "linear-gradient(135deg, #c79c0f 0%, #fda085 100%)",
  "linear-gradient(135deg, #a3bded 0%, #6991c7 100%)",
  "linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%)",
  "linear-gradient(135deg, #c2e9fb 0%, #a1c4fd 100%)",
  "linear-gradient(135deg, #ff9a9e 0%, #fad0c4 100%)",
