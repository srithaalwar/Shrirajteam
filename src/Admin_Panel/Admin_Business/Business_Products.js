...
//     product_commission: "",
//     distribution_commission: "",
//     verification_status: "pending" // Added verification_status field
//   });
...
//         product_commission: variant.product_commission || "0.00",
//         distribution_commission: variant.distribution_commission || "0.00",
//         verification_status: variant.verification_status || "pending" // Set verification_status
//       });
//     }
//   }, [variant]);
...
//                 {/* Verification Status Field - Same as Product Modal */}
//                 <div className="col-md-6 mb-3">
//                   <label className="form-label">Verification Status</label>
//                   <select
//                     className="form-select"
...
//         product_commission: formData.product_commission || "0.00",
//         distribution_commission: formData.distribution_commission || "0.00",
//         verification_status: formData.verification_status || "pending", // Added verification_status
//         attributes: attributes,
//         media: [{ media_type: "image" }]
//       };
//       onAdd(product.product_id, variantData);
...
//     switch(variant.verification_status) {
//       case 'verified': return <CheckCircle size={12} className="me-1" />;
//       case 'rejected': return <XCircle size={12} className="me-1" />;
//       default: return <Clock size={12} className="me-1" />;
//     }
//   };
...
//         {/* Verification Status - Moved below active/inactive */}
//         <div className="d-flex justify-content-between align-items-center mb-2">
//           <span className={`badge ${variant.verification_status === 'verified' ? 'bg-success' : variant.verification_status === 'rejected' ? 'bg-danger' : 'bg-warning'} d-flex align-items-center`}>
//             {getVerificationIcon()}
//             {variant.verification_status || 'pending'}
//           </span>
//         </div>
...
//           product_commission: variantData.product_commission || "0.00",
//           distribution_commission: variantData.distribution_commission || "0.00",
//           verification_status: variantData.verification_status || "pending" // Added verification_status
//         }
//       ]
//     };
...
const ActiveFiltersBar = ({ 
  ...
  return (
    <div className="d-flex align-items-center gap-2 mb-3 flex-wrap">
      {selectedPriceRanges.map(range => (
        <span key={range} className="badge bg-primary text-white d-flex align-items-center">
          <DollarSign size={12} className="me-1" />
          {getLabelFromValue(range, priceOptions)}
          <button 
            onClick={() => onRemovePriceFilter(range)} 
      ...
      {selectedDiscountRanges.map(range => (
        <span key={range} className="badge bg-success text-white d-flex align-items-center">
          <Tag size={12} className="me-1" />
          {getLabelFromValue(range, discountOptions)}
          <button 
            onClick={() => onRemoveDiscountFilter(range)} 
      ...
      variants: [
        {
          ...
          product_commission: variantData.product_commission || "0.00",
          distribution_commission: variantData.distribution_commission || "0.00",
          verification_status: variantData.verification_status || "pending"
        }
      ]
    };
