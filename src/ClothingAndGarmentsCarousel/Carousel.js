...
// const OfferCarousel = ({ categorySlug = "clothing-garments" }) => { // Add categorySlug prop with default
...
// const OfferCarousel = ({ categorySlug = "clothing-garments" }) => {
//   const [businesses, setBusinesses] = useState([]);
//   const [offersMap, setOffersMap] = useState({});
//   const [activeIndex, setActiveIndex] = useState(0);
//   const [loading, setLoading] = useState(true);
...
// const ClothingAndGarmentsCarousel = ({ categorySlug = "clothing-garments" }) => {
//   const [businesses, setBusinesses] = useState([]);
//   const [offersMap, setOffersMap] = useState({});
//   const [loading, setLoading] = useState(true);
//   const [categoryName, setCategoryName] = useState("");
...
// export default ClothingAndGarmentsCarousel;
