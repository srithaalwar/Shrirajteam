...
//     const existingItemIndex = guestCart.findIndex(item => item.variant_id === variant.id);
...
//   // New state variables for business view
...
//   // Determine view type from location state
//   useEffect(() => {
...
//     console.log("View type detection:", { passedBusinessId, passedBusinessName, passedCategoryId });
...
//         // For category view, fetch category name
...
//           // Business view: Fetch products for this specific business
...
//         } else if (viewType === "category" && effectiveCategoryId) {
...
//     if ((viewType === "business" && businessId) || (viewType === "category" && effectiveCategoryId)) {
//       fetchProducts();
//     }
//   }, [effectiveCategoryId, selectedCategories, viewType, businessId]);
...
//           <div className="msub-desktop-body">
//             {/* Sidebar - Always show for both category and business views */}
//             <aside className="msub-sidebar">
//               <div className="msub-sidebar-top">
//                 <span className="msub-sidebar-heading"><SlidersHorizontal size={15} /> Filters</span>
//                 {activeFilterCount > 0 && (
  ...
  if (isSidebar) {
    return (
      <div className="msub-sidebar-filter">
        ...
        <SidebarSection title="Sort By" count={0}>
...
const WebsiteSubCategories = () => {
  ...
  // Filter and sort products (removed search filter)
  const filteredProducts = useMemo(() => {
    let list = [...products];
    ...
    return list;
  }, [products, selectedPriceRanges, selectedDiscountRanges, sortBy]);

  useEffect(() => { setCurrentPage(1); }, [sortBy, selectedCategories, selectedPriceRanges, selectedDiscountRanges]);
  ...
  const productSection = productsLoading ? (
    ...
    <div className="msub-empty"><p>No products found</p><small>Try adjusting your filters</small></div>
  ) : (
    <>
      <div className={`msub-grid ${isMobile ? "msub-grid--2col" : "msub-grid--desktop"}`}>
        {paginated.map((item, index) => (
        ...
        <div className="msub-desktop">
          <div className="msub-desktop-body">
            ...
            <main className="msub-main">
              ...
              <div className="msub-main-topbar" style={{justifyContent:"space-between"}}>
