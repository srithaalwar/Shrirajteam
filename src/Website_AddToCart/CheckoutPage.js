...
//   // User Options
//   const [userType, setUserType] = useState("login"); // "login", "register"
...
//     password: "",
//     phone_number: "",
//     role_ids: [], // Will default to customer role
//     address: "",
//     city: "",
//     state: "",
//     pincode: "",
...
//   // Validate Registration
//   const validateRegistration = () => {
//     const { first_name, last_name, email, password, phone_number, address, city, state, pincode } = registerInfo;
...
//     if (!phoneRegex.test(phone_number)) errors.push("Valid 10-digit phone number is required");
...
//         first_name: registerInfo.first_name.trim(),
//         last_name: registerInfo.last_name.trim(),
//         email: registerInfo.email.trim(),
//         password: registerInfo.password,
//         phone_number: registerInfo.phone_number.trim(),
//         role_ids: [4], // Assuming 4 is the customer role ID, change as needed
//         status: "active",
//         kyc_status: "pending",
//         address: registerInfo.address.trim(),
//         city: registerInfo.city.trim(),
//         state: registerInfo.state.trim(),
//         pincode: registerInfo.pincode.trim(),
//         country: registerInfo.country
//       };
...
//       if (response.ok) {
//         // Now login the user with the same credentials
...
//           // Convert guest cart to user cart
//           await convertGuestCartToUserCart(loginData.user.id);
...
//         if (data.email) {
//           errorMessage = Array.isArray(data.email) ? data.email[0] : "Email already exists";
//         } else if (data.phone_number) {
//           errorMessage = Array.isArray(data.phone_number) ? data.phone_number[0] : "Phone number already exists";
...
//       // Send order
//       const response = await fetch(`${baseurl}/orders/user-order`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           "Authorization": `Bearer ${localStorage.getItem("user_token")}`
...
//         // Clear cart
//         if (localStorage.getItem("website_guest_cart")) {
//           localStorage.removeItem("website_guest_cart");
//         }
//         window.dispatchEvent(new Event('cartUpdated'));
...
//           <div className="checkout-steps">
//             <div className="step active">1. Cart</div>
//             <div className="step active">2. Login/Register</div>
//             <div className="step">3. Payment</div>
//             <div className="step">4. Confirm</div>
//           </div>
//         </div>
...
//             {!isLoggedIn && (
//               <section className="checkout-section">
//                 <h2>Login or Create Account to Continue</h2>
//                 <div className="user-options">
//                   <div className="user-option-tabs">
//                     <button 
//                       className={`user-tab ${userType === "login" ? "active" : ""}`}
...
//                       {/* Phone & Role (Hidden - Auto-set to Customer) */}
//                       <div className="form-grid">
//                         <div className="form-group">
...
//                             All checkout users are registered as customers
//                           </small>
//                         </div>
//                       </div>
...
//                       <p><strong>Address:</strong> {currentUser.address}, {currentUser.city}, {currentUser.state} - {currentUser.pincode}</p>
//                     </div>
//                     <button 
//                       onClick={() => {
//                         localStorage.removeItem("user_token");
...
//             {/* Benefits of Registration (for login users) */}
//             {userType === "login" && !isLoggedIn && (
//               <div className="registration-benefits">
//                 <h4>Benefits of Creating an Account:</h4>
//                 <ul className="benefit-list">
//                   <li>Track all your orders in one place</li>
...
//             {/* Terms & Conditions (only show if logged in) */}
//             {isLoggedIn && (
//               <div className="terms-agreement">
//                 <label className="checkbox-label">
//                   <input
...
//                 onClick={handlePlaceOrder}
//                 className="place-order-btn"
//                 disabled={!isLoggedIn || !agreedToTerms}
//               >
//                 {paymentMethod === "cod" ? "Place Order" : "Proceed to Payment"}
//               </button>
//             </div>
