...
// Date - 10-03-2026   adjusted add to cart 
...
const ClientProductDetails = () => {
  ...
  /* ================= SHARE FUNCTIONALITY ================= */
  const handleShareClick = () => {
    const currentUrl = `${window.location.origin}/client-business-product-details/${productId}/?variant=${variantId || selectedVariant?.id}`;
